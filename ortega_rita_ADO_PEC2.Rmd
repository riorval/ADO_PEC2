...
```{r filtrar_anotacion}
#Filtramos los genes que no tienen entrezgeneID
DGEFiltered$anotation <- anotationTable[!is.na(anotationTable$entrezgene_id),
                                     c("external_gene_name", "ensembl_gene_id", "entrezgene_id", "go_id", "name_1006")]
head(DGEFiltered$anotation)
```
