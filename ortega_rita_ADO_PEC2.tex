...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{>}\StringTok{ }\CommentTok{# Primero cambiamos los guiones por puntos}
\ErrorTok{>}\StringTok{ }\NormalTok{newShortNames <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"_"}\NormalTok{, }\StringTok{"."}\NormalTok{, mytargets}\OperatorTok{$}\NormalTok{ShortName)}
\OperatorTok{>}\StringTok{ }\NormalTok{mytargets}\OperatorTok{$}\NormalTok{ShortName <-}\StringTok{ }\KeywordTok{gsub}\NormalTok{(}\StringTok{"-"}\NormalTok{, }\StringTok{""}\NormalTok{, newShortNames)}
\OperatorTok{>}\StringTok{ }
\ErrorTok{>}\StringTok{ }\CommentTok{# Asignamos los nombres cortos a las columnas de mycounts}
\ErrorTok{>}\StringTok{ }\KeywordTok{colnames}\NormalTok{(mycounts) <-}\StringTok{ }\NormalTok{mytargets}\OperatorTok{$}\NormalTok{ShortName}
\end{Highlighting}
\end{Shaded}
